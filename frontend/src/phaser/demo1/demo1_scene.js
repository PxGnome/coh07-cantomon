...
export default class Demo1Scene extends Phaser.Scene {
    preload() {
        this.load.atlas('knight', "/demos/demo1/knight.png", "/demos/demo1/knight.json");
        this.load.image('bg', "/demos/demo1/clouds.png");
        this.load.spritesheet('tiles', "/demos/demo1/fantasy-tiles.png", { frameWidth: 64, frameHeight: 64 });
    }
