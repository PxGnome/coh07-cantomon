                    ...
                    <div className="list-group-header-wrapper">
                        <div className="combination">
                            <div className="list-group-header">
                                ...
                                <div className="title middle">Battling</div>
                                    ...
                                    <div className="row action_menu">
                                        <div className="container-fluid">
                                            <div className="row">
                                                ...
                                                <div className="col-8 text_wrapper">NPC 1</div>
                                            </div>
                                            <div className="row">
                                                <div className="col-4 image_wrapper"></div>
                                                <div className="col-8 text_wrapper">NPC 2</div>
                                            </div>
                                            <div className="row">
                                                <div className="col-4 image_wrapper"></div>
                                                <div className="col-8 text_wrapper">Random Enemy 1</div>
                                            </div>
                                            <div className="row">
                                                <div className="col-4 image_wrapper"></div>
                                                <div className="col-8 text_wrapper">Random Enemy 2</div>
                                            </div>
                                            <div className="row">
                                                <div className="col-4 image_wrapper"></div>
                                                <div className="col-8 text_wrapper">Random Enemy 3</div>
                                            </div>
                                        </div>
                                    </div>
